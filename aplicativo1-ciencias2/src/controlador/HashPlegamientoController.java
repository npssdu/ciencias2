...
public class HashPlegamientoController {
    private HashPlegamientoModel model;
    private final HashPlegamientoView view;
    private final Path baseDir = Paths.get("archivos/HashPlegamiento");
    private final boolean modoBloques;

    public HashPlegamientoController(HashPlegamientoModel m, HashPlegamientoView v) {
        this(m, v, false);
    }
    public HashPlegamientoController(HashPlegamientoModel m, HashPlegamientoView v, boolean modoBloques) {
        this.model = m;
        this.view = v;
    ...
    private void crear() {
        try {
            ...
            model = new HashPlegamientoModel(t);
            model.reiniciar();
            log("HashPlegamiento tabla tamaño=" + t);
            actualizarTabla();
